...
Apply
Если нужен пример кода для любого из этих файлов — дайте знать, и я подготовлю шаблон!
Этот подход позволит вам легко масштабировать проект и переиспользовать компоненты на других страницах.