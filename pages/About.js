...
export class AboutPage extends Page {
    ...
    init() {
        this.setTitle('О нас');
        this.setMeta(
            'О платформе Без Кордонів - как мы помогаем найти экспертов',
            'о нас, о компании, эксперты, поиск экспертов, консультации'
        );
    }
            ...
            <div class="about-find-inner">
                <div class="about-find-left">
                    <div class="about-find-images">
                        <img class="about-find-ellipse-1" src="./img/about-find-ellipse-1.svg" alt="">
                        <img class="about-find-hero" src="./img/about-find.png" alt="">
                        <img class="about-find-ellipse-2" src="./img/about-find-ellipse-2.svg" alt="">
                    </div>
                </div>
                <div class="about-find-content">
                    <img class="about-find-img" src="./img/icons/about-find.svg" alt="">
        ...
        <div class="section-lg-inner">
            <div class="about-support-inner">
                <div class="about-support-content">
                    <img class="about-support-img" src="./img/icons/about-support.svg" alt="">
                ...
                <div class="about-support-right">
                    <div class="about-support-images">
                        <img class="about-support-ellipse-1" src="./img/about-support-ellipse-1.svg" alt="">
                        <img class="about-support-hero" src="./img/about-support-hero.jpg" alt="">
                        <img class="about-support-ellipse-2" src="./img/about-support-ellipse-2.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="about-opening-inner">
                <div class="about-opening-left">
                    <div class="about-opening-images">
                        <img class="about-opening-ellipse-1" src="./img/about-opening-ellipse-1.svg" alt="">
                        <img class="about-opening-hero" src="./img/about-opening-hero.png" alt="">
                        <img class="about-opening-ellipse-2" src="./img/about-opening-ellipse-2.svg" alt="">
                    </div>
                </div>
            ...
            <div class="about-social-inner">
                ...
                <div class="about-social-links">
                    <a class="about-social-link" href="">
                        <img src="./img/icons/telegram-color.svg" alt="">
                        <p>Telegram</p>
                    </a>
                    <a class="about-social-link" href="">
                        <img src="./img/icons/instagram-color.svg" alt="">
                        <p>Instagram</p>
                    </a>
                    <a class="about-social-link" href="">
                        <img src="./img/icons/facebook-color.svg" alt="">
                        <p>Facebook</p>
                    </a>
                    <a class="about-social-link" href="">
                        <img src="./img/icons/linkedin-color.svg" alt="">
                        <p>LinkedIn</p>
                    </a>
                </div>
            </div>
