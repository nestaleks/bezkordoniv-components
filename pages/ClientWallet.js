             ...
             <section class="client-wallet-page">
                <div class="container">
                        ...
                        <div class="wallet-history-body">
                            <div class="wallet-history-filters">
                                ...
                                <button class="sorting-by">
                                    <img src="./img/icons/sorting-by.svg" alt="">
                                </button>
                            </div>
                            <ul class="wallet-history-list">
                                ...
                                <li class="wallet-history-item">
                                    ...
                                    <div class="history-status">
                                        <img src="./img/icons/appoints-canceled.svg" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="client-wallet-modal">
                        ...
                        <div class="modal-recharge-balance" id="modal-recharge-balance">
                        ...
                        <div class="modal-pay-appointment-item" id="modal-pay-appointment-item">
                            <div class="modal-content">
                                <div class="modal-header">
                        ...
                        <div class="modal-pay-appointment-item" id="payment-modal-newcard">
                            <div class="modal-content">
                                <div class="modal-window-close">
