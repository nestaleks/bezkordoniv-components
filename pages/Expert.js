...
export class ExpertPage extends Page {
    render() {
                    ...
                    <div class="expert-card-inner">
                        <div class="expert-card-left">
                            <div class="expert-card-head">
                                <img class="expert-card-head-img" src="./img/expert-1.png" alt="">
                            ...
                            <div class="tabs">
                                <div class="tabs-inner">
                                    <button class="tabs-item expert-card-tabs-info">
                            ...
                            <div class="expert-card-service-box">
                                    ...
                                    <li class="expert-card-service-item">
                                        <div class="expert-card-service-top">
                                            ...
                                            <div class="expert-card-service-price">
                                                <img src="./img/icons/money-purple.svg" alt="" class="icon">
                                                <p>100€</p>
                                                <p>/</p>
                                                <p>45 хвилин</p>
                                            </div>
                                ...
                                <ul class="expert-card-lastreviews">
                                    <li class="expert-card-lastreview">
                                        <div class="expert-card-lastreview-left">
                                            <img class="expert-card-lastreview-photo" src="./img/expert-3.png" alt="">
