// Компонент ClientMeetings - зустрічі клієнта
const ClientMeetings = (props = {}) => {
    // Создаем breadcrumb для страницы ClientMeetings
                        ...
                        <li class="client-meetings-item">
                            ...
                            <div class="client-meetings-item-body">
                                <div class="client-meetings-item-info">
                                    <a href="/client-meeting" data-link data-meeting-id="1" class="client-meetings-item-expert">
                                        <img class="client-meetings-item-img" src="./src/img/expert-1.png" alt="">
                                    ...
                                    <div class="client-meetings-item-payments">
                                        ...
                                        <button class="client-meetings-item-pay button-primary" data-amount="$100.00" data-service="Консультація" data-modal="paymentModal">
                            ...
                            <div class="client-meetings-item-body">
                                <div class="client-meetings-item-info">
                                    <div class="client-meetings-item-expert">
                                        <img class="client-meetings-item-img" src="./src/img/expert-3.png" alt="">
                                        <div class="client-meetings-item-about">
                                    ...
                                    <div class="client-meetings-item-payments">
                                        ...
                                        <button class="client-meetings-item-pay button-primary" data-amount="$100.00" data-service="Пломбування" data-modal="paymentModal">
                                            <img src="./src/img/icons/money-white.svg" alt="">
                                            <p>Сплатити</p>
                                        </button>
                                    </div>
