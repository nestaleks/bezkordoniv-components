// Компонент SignUp Page
const SignUp = (props = {}) => {
    return `
        <main class="main signup-page">
            <div class="signup-images">
                ...
                <div class="signup-container">
                    ...
                    <div class="signup-tabs">
                        <button class="tab-button active" data-tab="client">
                            <p>Клієнт</p>
                            <img class="tab-button-img" src="./src/img/icons/signup-client.svg" alt="">
                        </button>
                        <button class="tab-button" data-tab="expert">
                            <p>Експерт</p>
                            <img class="tab-button-img" src="./src/img/icons/signup-expert.svg" alt="">
                        </button>
                    </div>

                    <!-- Sign up for clients and Step 1 for Experts -->
                    <form class="signup-form step-1">
                        <div class="expert-step-1 mb-20" style="display: none;">
                            <div class="step-1-item">
                                <img src="./src/img/icons/location-blue.svg" alt="">
                                <p>1 Крок. Контактна Інформація</p>
                            </div>
                            <img src="./src/img/icons/details-gray.svg" alt="">
                            <div class="step-1-item">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <select class="form-select">
                                    ...
                                    <option value="berlin">Берлін</option>
                        ...
                        <div class="social-links">
                            ...
                            <div class="social-icons">
                                <a href="#" class="social-icon"><img src="./src/img/icons/facebook.svg" alt="Facebook"></a>
                                <a href="#" class="social-icon"><img src="./src/img/icons/instagram.svg" alt="Instagram"></a>
                                <a href="#" class="social-icon"><img src="./src/img/icons/linkedin.svg" alt="LinkedIn"></a>
                                <a href="#" class="social-icon"><img src="./src/img/icons/telegram.svg" alt="Telegram"></a>
                                <a href="#" class="social-icon"><img src="./src/img/icons/whatsapp.svg" alt="WhatsApp"></a>
                            </div>
                        </div>

                        <div class="form-actions">
                            <a href="/login" class="have-account button-secondary" data-link>Вже є Акаунт? Увійти</a>
                            <button type="submit" class="signup-submit button-primary">Зареєструватись</button>
                            <button type="button" class="continue-button button-primary" style="display: none;">Продовжити</button>
                        </div>
                    </form>
                    <!-- Sign up Step 2 for Experts -->
                    <form class="signup-form step-2" style="display: none;">
                        <div class="expert-step-2 mb-20">
                            ...
                            <img src="./src/img/icons/details-gray.svg" alt="">
                            <div class="step-2-item">
                                <img src="./src/img/icons/shield_blue.svg" alt="">
                                <p>2 Крок. Професійна Інформація</p>
                            </div>
                        </div>
                ...
                <div class="signup-container-success hidden">
                    ...
                    <p class="success-message">Будь ласка, перевірте вашу пошту бо ми надіслали вам лінк на верифікацію.</p>
                    <div class="form-actions">
                        <a href="/signup" class="have-account button-secondary" data-link>Зареєструватись</a>
                        <a href="/login" class="have-account button-primary" data-link>Увійти</a>
                    </div>
                </div>
        </main>
    `;
