                ...
                <div class="section-lg-inner">
                    ...
                    <ul class="categories-tiles">
                        <li class="category-tile color-1">
                            <a href="">Медичні</a>
                            <img src="./src/img/patterns/medical.svg" alt="">
                        </li>
                        <li class="category-tile color-2">
                            <a href="">Психологічні</a>
                            <img src="./src/img/patterns/psyhology.svg" alt="">
                        </li>
                        <li class="category-tile color-3">
                            <a href="">Юридичні</a>
                            <img src="./src/img/patterns/law-service.svg" alt="">
                        </li>
                        <li class="category-tile color-5">
                            <a href="">ІТ та технології</a>
                            <img src="./src/img/patterns/it-technology.svg" alt="">
                        </li>
                        <li class="category-tile color-3">
                            <a href="">Фінансові</a>
                            <img src="./src/img/patterns/finance.svg" alt="">
                        </li>
                        <li class="category-tile color-4">
                            <a href="">Освітні</a>
                            <img src="./src/img/patterns/education.svg" alt="">
                        </li>
                        <li class="category-tile color-2">
                            <a href="">Маркетинг</a>
                            <img src="./src/img/patterns/marketing.svg" alt="">
                        </li>
                        <li class="category-tile color-4">
                            <a href="">Дизайн</a>
                            <img src="./src/img/patterns/design.svg" alt="">
                        </li>
                        <li class="category-tile color-1">
                            <a href="">Бізнес</a>
                            <img src="./src/img/patterns/business.svg" alt="">
                        </li>
                        <li class="category-tile color-5">
                            <a href="">Комунікації</a>
                            <img src="./src/img/patterns/communication.svg" alt="">
                        </li>
                        <li class="category-tile color-3">
                            <a href="">Продажі</a>
                            <img src="./src/img/patterns/sales.svg" alt="">
                        </li>
                        <li class="category-tile color-2">
                            <a href="">Логістика</a>
                            <img src="./src/img/patterns/logistic.svg" alt="">
                        </li>
                        <li class="category-tile color-4">
                            <a href="">Віртуальні послуги</a>
                            <img src="./src/img/patterns/virtual.svg" alt="">
                        </li>
                    </ul>
                </div>
                        ...
                        <ul class="how-to-order-list mt-20">
                            <li class="how-to-order-item">
                                <div class="how-to-order-images">
                                    <img class="how-to-order-ellipse-1" src="./src/img/how-to-order-1a.svg" alt="">
                                    <img class="how-to-order-hero" src="./src/img/how-to-order-1b.png" alt="">
                                    <img class="how-to-order-ellipse-2" src="./src/img/how-to-order-1c.svg" alt="">
                                </div>
                                <p class="how-to-order-text">Оберіть фільтр <b>прямо зараз</b> або <b>найближчий запис</b> на зручний час</p>
                            </li>
                            <li class="how-to-order-item">
                                <div class="how-to-order-images">
                                    <img class="how-to-order-ellipse-1" src="./src/img/how-to-order-2a.svg" alt="">
                                    <img class="how-to-order-hero" src="./src/img/how-to-order-2b.png" alt="">
                                    <img class="how-to-order-ellipse-2" src="./src/img/how-to-order-2c.svg" alt="">
                                </div>
                                <p class="how-to-order-text">Оберіть лікаря за <b>рейтингом, відгуком, вартістю</b></p>
                            </li>
                            <li class="how-to-order-item">
                                <div class="how-to-order-images">
                                    <img class="how-to-order-ellipse-1" src="./src/img/how-to-order-3a.svg" alt="">
                                    <img class="how-to-order-hero" src="./src/img/how-to-order-3b.png" alt="">
                                    <img class="how-to-order-ellipse-2" src="./src/img/how-to-order-3c.svg" alt="">
                                </div>
                                <p class="how-to-order-text">Спаліть послугу та <b>отримайте підтвердження оплати</b></p>
                            </li>
                            <li class="how-to-order-item">
                                <div class="how-to-order-images">
                                    <img class="how-to-order-ellipse-1" src="./src/img/how-to-order-4a.svg" alt="">
                                    <img class="how-to-order-hero" src="./src/img/how-to-order-4b.png" alt="">
                                    <img class="how-to-order-ellipse-2" src="./src/img/how-to-order-4c.svg" alt="">
                                </div>
                    ...
                    <div class="who-need-it-inner">
                        <div class="who-need-it-left">
                            <div class="who-need-it-images">
                                <img class="who-need-it-ellipse-1" src="./src/img/who-need-it-ellipse-1.svg" alt="">
                                <img class="who-need-it-hero" src="./src/img/who-need-it-hero.jpeg" alt="">
                                <img class="who-need-it-ellipse-2" src="./src/img/who-need-it-ellipse-2.svg" alt="">
                            </div>
                    ...
                    <ul class="main-blog-list">
                        <li class="main-blog-item">
                            <a href="#" data-link-blog data-post-id="1">
                                ...
                                <img class="main-blog-img" src="./src/img/blog-item-1.png" alt="">
                            </a>
                        </li>
                        <li class="main-blog-item">
                            <a href="#" data-link-blog data-post-id="2">
                                ...
                                <img class="main-blog-img" src="./src/img/blog-item-2.png" alt="">
                            </a>
                        </li>
                        <li class="main-blog-item">
                            <a href="#" data-link-blog data-post-id="3">
                                ...
                                <img class="main-blog-img" src="./src/img/blog-item-3.png" alt="">
                            </a>
                        </li>
                        <li class="main-blog-item">
                            <a href="#" data-link-blog data-post-id="4">
                                ...
                                <img class="main-blog-img" src="./src/img/blog-item-4.png" alt="">
                            </a>
                        </li>
                        <li class="main-blog-item">
                            <a href="#" data-link-blog data-post-id="5">
                                ...
                                <img class="main-blog-img" src="./src/img/blog-item-5.png" alt="">
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <section class="questions section-lg"  id="faq">
                <div class="section-lg-inner">
                    <div class="questions-header mb-20">
                        ...
                        <a href="/faq" class="questions-more" data-link>
                            <p>Детальніше</p>
                        </a>
                    </div>
                ...
                <div class="section-lg-inner">
                    ...
                    <div class="locations-list">
                        <div class="locations-item">
                            <img class="locations-item-img" src="./src/img/icons/countries/germany.svg" alt="">
                        ...
                        <div class="locations-item">
                            <img class="locations-item-img" src="./src/img/icons/countries/slovakia.svg" alt="">
                            <div class="locations-item-box">
                        ...
                        <div class="locations-item">
                            <img class="locations-item-img" src="./src/img/icons/countries/poland.svg" alt="">
                            <div class="locations-item-box">
                        ...
                        <div class="locations-item">
                            <img class="locations-item-img" src="./src/img/icons/countries/ukraine.svg" alt="">
                            <div class="locations-item-box">
